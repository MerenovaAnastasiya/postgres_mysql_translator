package merenaas.com.postgres_translator.connector.util;

import lombok.RequiredArgsConstructor;
import merenaas.com.postgres_translator.connector.model.MySQLColumnInformation;
...
public class PgMySQLTypesConvertor {
    ...
    private String convertType(PgColumnInformation information) {
